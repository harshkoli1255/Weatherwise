...
<p align="center">
  <img src="./public/WeatherwiseLightThemeScreenshot.png" alt="The Weatherwise dashboard showing real-time weather data for New York." style="border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);" width="49%">&nbsp;&nbsp;
  <img src="./public/WeatherwiseDarkThemeScreenshot.png" alt="The Weatherwise dashboard showing real-time weather data for New York." style="border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);" width="49%">
</p>
