...
6.  **Generate Key Insights:** Provide a short list (2-3 bullet points) of the most important, non-obvious insights from the data for a "Key Insights" section. Focus on what's impactful and requires synthesis by analyzing both current conditions and the hourly forecast if available. **You MUST use \`<strong>\` tags to highlight the most critical part of each insight.** Examples of insights: "Feels like temperature is <strong>5°C colder</strong> due to wind.", "<strong>High chance of rain</strong> starting this evening.", "Temperature will <strong>drop significantly</strong> after sunset." These should be concise strings in an array.
`;
