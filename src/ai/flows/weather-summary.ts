...
6.  **Generate Key Insights:** Provide a short list (2-3 bullet points) of the most important, non-obvious insights from the data for a "Key Insights" section. Focus on what's impactful and requires synthesis. Examples: "Feels like temperature is 5°C colder due to wind.", "High chance of rain starting this evening.", "Unusually high humidity today." These should be concise strings in an array.
`;
