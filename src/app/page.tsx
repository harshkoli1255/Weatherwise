...
function WeatherPageContent() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8 md:py-10 flex flex-col items-center">
      ...
      {isLoadingDisplay && (
        <Card className="w-full max-w-4xl mt-4 bg-glass border-primary/20 p-6 sm:p-8 rounded-xl shadow-2xl">
      ...
      {!isLoadingDisplay && !weatherState.data && weatherState.error && (
           <Card className="w-full max-w-4xl mt-4 border-destructive/50 bg-destructive/10 backdrop-blur-lg shadow-xl p-6 sm:p-8 rounded-xl">
