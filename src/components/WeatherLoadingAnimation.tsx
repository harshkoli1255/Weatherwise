    ...
    <div className={cn("flex flex-col items-center justify-center space-y-6 text-center", className)}>
      <div className="relative h-28 w-28">
        ...
        <svg
          ...
          className="relative h-full w-full drop-shadow-lg overflow-visible"
        >
          <g className="animate-cloud-drift-back">
            <path
          ...
          <g transform="translate(-10, -10)" className="animate-cloud-drift-front">
            <path
