        ...
        <CardHeader className="text-center pt-6 pb-4 items-center border-b border-border/50">
          <div className="flex items-center justify-center gap-2">
            ...
            <Button
              ...
              className="h-9 w-9 text-yellow-400 hover:text-yellow-300"
              title={isCitySaved ? `Remove ${weatherData.city} from saved` : `Save ${weatherData.city}`}
            >
              <Star className={cn("h-7 w-7 transition-all duration-300", isCitySaved ? 'fill-yellow-400' : 'fill-transparent')} />
            </Button>
          </div>
